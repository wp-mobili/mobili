...
<div class="upload-theme">
    ...
    <form method="post" enctype="multipart/form-data" class="wp-upload-form" action="<?php echo esc_attr($upload_url); ?>">
        <input type="hidden" id="_wpnonce" name="_wpnonce" value="<?php echo esc_attr($upload_nonce); ?>">
