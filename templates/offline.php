...
<html lang="en">
<head>
    <title><?php _e('You are offline :(','mobili'); ?></title>
    <meta charset="utf-8">
...
<div class="page-inner">
    ...
    <h1 class="page-title"><?php _e('You are offline :(','mobili'); ?></h1>
    <p class="page-desc"><?php _e('Make sure you have an internet connection.','mobili'); ?></p>
    <button class="button" onclick="window.location.reload()"><?php _e('Reload page','mobili'); ?></button>
</div>
</body>
</html>
